...
{
    return "\t\tvoid "+class_name+"::set_"+column_name+"( double _value, bool set_null) { update_flag.set("+std::to_string(col_index)+"); "+field_name+"=_value; if(set_null) null_flag.set("+std::to_string(col_index)+"); } \n";
}
