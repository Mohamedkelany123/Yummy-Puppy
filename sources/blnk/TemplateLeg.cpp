...
void TemplateLeg::setDebitAccountId(int _debit_account_id) { debit_account_id = _debit_account_id;}
void TemplateLeg::setCreditAccountId(int _credit_account_id) { credit_account_id = _credit_account_id;}
void TemplateLeg::setBondIdRequired(bool _bond_id_required){ bond_id_required=_bond_id_required;}
void TemplateLeg::setLatefeeIdRequired(bool _latefee_id_required){ latefee_id_required=_latefee_id_required;};
...
const bool TemplateLeg::getLatefeeIdRequired() { return latefee_id_required; }
