...
def main():
    ...
    # DB_c_url = "postgres://postgres:postgres@192.168.65.203/before_closure_01012024_testing" 
    # DB_python = "postgres://postgres:postgres@192.168.65.203/before_closure_01012024_django"
