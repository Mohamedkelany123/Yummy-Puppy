...
class PSQLController
{
    ...
    public:
        ...
        void ORMCommit_me(bool parallel,bool transaction,bool clean_updates);
        void ORMCommit_me(bool parallel,bool transaction,bool clean_updates,string data_source_name);
        void ORMFlush();
