...
class PSQLController
{
    ...
    public:
        ...
        map<string, vector<long>> ORMCommit_me(bool transaction=false,bool clean_updates=true);
        map<string, vector<long>> ORMCommit_me(string data_source_name, bool transaction=false,bool clean_updates=true);
        void ORMFlush();
