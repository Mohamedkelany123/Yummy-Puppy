...
PSQLJoinQueryIterator *CancelLateFees::aggregator(QueryExtraFeilds * query_feilds)
{
    ...
    psqlQueryJoin->filter(
        ANDOperator(
            ...
            new UnaryOperator("new_lms_installmentlatefees.cancellation_date", lte, query_feilds->closure_date_string),
