...
$(BIN_SERVICES)/%: $(OBJECTS)/mains/cmd_services/%.cpp.o $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) 
	$(GCC) $(INCLUDES) $(LEDGERINCLUDES)  $(LIBS) $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY)  $< -o $@ $(LINKER_FLAGS)
...
$(BIN_SHARED)/%.so: $(OBJECTS)/mains/cmd_services/%.cpp.o $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) 
	$(GCC) -shared $(INCLUDES) $(LEDGERINCLUDES) $(LIBS) $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) $< -o $@ $(LINKER_FLAGS)
