...
.SECONDARY: $(OBJS_MAINS) $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) $(OBJS_BL_FACTORY)  $(OBJS_CMD_MAINS)

$(BIN_SERVICES)/%: $(OBJECTS)/mains/cmd_services/%.cpp.o $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) $(OBJS_BL_FACTORY)  
	$(GCC) $(INCLUDES) $(LEDGERINCLUDES)  $(LIBS) $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) $(OBJS_BL_FACTORY)   $< -o $@ $(LINKER_FLAGS)

$(BIN_SHARED)/%.so: $(OBJECTS)/mains/cmd_services/%.cpp.o $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) $(OBJS_BL_FACTORY)  
	$(GCC) -shared $(INCLUDES) $(LEDGERINCLUDES) $(LIBS) $(OBJS) $(OBJS_BLNK) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) $(OBJS_BL_FACTORY)  $< -o $@ $(LINKER_FLAGS)
...
$(TEST_BIN): $(TEST_OBJ) $(OBJS) $(OBJS_ABSTRACT) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) $(OBJS_BL_FACTORY)  $(TEST_BIN_DIR)
	$(GCC) $(INCLUDES) $(LIBS) $(GTEST_INCLUDE) -g -o $@ $(TEST_OBJ) $(OBJS) $(OBJS_ABSTRACT) $(OBJS_BLNK) $(OBJS_POSTGRES) $(OBJS_POSTGRES_COLUMN_TYPES) $(OBJS_FACTORY) $(OBJS_BL_FACTORY)  $(GTEST_LIB) $(LINKER_FLAGS)
