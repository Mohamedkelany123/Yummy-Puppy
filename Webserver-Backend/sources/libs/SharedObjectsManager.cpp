...
// template <class T>
//  SharedObjectsManager<T>::SharedObjectsManager(){} // Constructor

// template <class T>
// T * SharedObjectsManager<T>::load(string name) {{ // Load object form DSO
...
// template<class T>
// SharedObjectsManager<T>::~SharedObjectsManager()
// {
